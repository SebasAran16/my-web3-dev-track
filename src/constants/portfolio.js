export const experiences = [
  ...
  },
  {
    ...
    description: [
      ...
      "Having worked from building projects from scratch with no team to teach someone how to code his first Smart Contract, leaving all the basis and resources to follow the study, has given me a solid basis to every project.",
    ],
  },
];
...
export const web2Courses = [
  ...
  },
  {
    ...
    images: [
      { src: "/teachers/freecodecamp.png", alt: "FreeCodeCamp Logo" },
      { src: "/teachers/alicia.jpg", alt: "Patricia Rodriguez" },
    ],
  },
  {
    key: "zach",
...
export const projects = [
  ...
  },
  {
    ...
    descriptionKeys: [
      "portfolio.projectsMade.mutantBeers.description.1",
      "portfolio.projectsMade.mutantBeers.description.2",
    ],
    siteButtonKey: "portfolio.projectsMade.mutantBeers.siteButton",
    codeButtonKey: "portfolio.projectsMade.mutantBeers.codeButton",
    siteUrl: "https://mutant-beers.vercel.app/",
    codeUrl:
